                ...
                <section className='flex items-center justify-center'>
                    <div className='bg-neutral-900/[.75] flex flex-col h-full justify-between max-w-screen-xl w-4/5 px-3 border-neutral-900 border-x-2'>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            {preStart && (
                            <button className='bg-gradient-to-b from-black/[.65] to-neutral-900/[.65] font-red-rose py-10 w-1/2 text-center text-neutral-200 text-5xl border-neutral-900 border-2 rounded-sm' 
